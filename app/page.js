...
export default async function HomePage() {
  ...
  return (
    <main>
      <header className="site-header"><div className="shell site-header-inner"><Link className="wordmark" href="/">DAVID//WRITES</Link><nav className="nav"><a href="#library">Library</a><Link href="/admin">Admin</Link></nav></div></header>
