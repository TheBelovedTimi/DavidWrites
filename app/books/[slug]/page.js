...
export async function generateMetadata({params}){
  ...
  const description=book.description || book.teaser || `Read ${book.title} on David Writes.`;
  return {
    title:book.title,
    description,
